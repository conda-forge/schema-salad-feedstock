...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/schema-salad-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/schema-salad-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add schema-salad
# for installing globally
pixi global install schema-salad
```
...
It is possible to list all of the versions of `schema-salad` available on your platform:
...
```
pixi search schema-salad --channel conda-forge
```
